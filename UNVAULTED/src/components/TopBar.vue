<template>
  <nav
    class="fixed top-[2vh] left-1/2 transform -translate-x-1/2 w-[90%] max-w-[100vw] z-50 rounded-xl border border-[var(--color-border)] bg-white/60 backdrop-blur-md flex items-center justify-between px-6 py-3"
  >
